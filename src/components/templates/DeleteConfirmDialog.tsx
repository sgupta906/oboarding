      ...
      footer={
        <div className="flex gap-3 justify-end">
          <button
            onClick={onCancel}
            disabled={isDeleting}
            className="px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-100 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-colors dark:text-slate-300 dark:hover:bg-slate-600"
    ...
    >
      <div className="flex gap-4">
        ...
        <div className="flex-1">
          <p className="text-sm text-slate-700 mb-2 dark:text-slate-200">
